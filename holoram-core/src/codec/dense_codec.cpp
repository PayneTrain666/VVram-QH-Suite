...
HoloEncodeResult encode_dense(const void* decoded, std::uint32_t decoded_bytes, const HoloCodecConfig& cfg, const HoloCodebook&, HoloChannelId) {
...
HoloDecodeResult decode_dense(const void* payload, std::uint32_t payload_bytes, const HoloCodecConfig&, const HoloCodebook&, HoloChannelId) {
